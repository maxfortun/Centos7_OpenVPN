...
yum -y install epel-release openvpn easy-rsa policycoreutils-python iptables-services traceroute net-tools NetworkManager-config-routing-rules bind bind-utils iptables initscripts
