...
yum -y install epel-release openvpn easy-rsa policycoreutils-python iptables-services bind-utils traceroute net-tools NetworkManager-config-routing-rules bind bind-utils
